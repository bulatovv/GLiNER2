...
> **Hosted option:** if you'd rather not manage GPUs, the [Fastino API](https://fastino.ai) can also fine-tune and serve GLiNER models, which is usually faster than training locally. Everything below works fully offline without it.
